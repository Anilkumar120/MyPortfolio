                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-lg-8 col-xl-6">
                            ...
                            <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="post"
                                ...
                                <a href="table.php" type="submit" name="submit"
                                        class="btn btn-primary btn-lg  d-grid" id="submitButton">Submit</a>
                            </form>
    ...
    public $con;
          ...
          public function insert(){
            if(isset($_POST['submit'])){
                ...
                $insert="INSERT INTO `contect_us`( `fullname`, `email`, `phone`, `message`) VALUES ('$fullname','$email','$phone','$message')";
